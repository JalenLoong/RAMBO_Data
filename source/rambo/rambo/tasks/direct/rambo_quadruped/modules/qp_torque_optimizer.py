...
class QPTorqueOptimizer:
    ...
    def __init__(self, env):
        ...
        # ``--viz none`` must not subscribe a Kit post-update callback.  The
        # visualizer remains available in the explicitly allowed Kit mode.
...
def compute_desired_acc(
    ...
    # Isaac Lab 3 state/math is XYZW; RAMBO's historical QP/checkpoint
    # orientation error is deliberately retained in WXYZ behind this boundary.
